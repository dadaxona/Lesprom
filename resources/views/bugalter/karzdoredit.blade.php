...
@section('control')
    ...
    <h1 style="text-align: center">Yuridik shaxslarning karzlarini to`lash bo`limi</h1>

    <form action="{{ route('yuridik',$date->id) }}" method="POST">
            @csrf
                ...
                <div class="col-6 mt-3">
                    <input type="number" name="karzsumma" class="form-control" placeholder="Summani kiriting" value="{{ old('karzsumma') }}">
