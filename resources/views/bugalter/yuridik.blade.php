...
@section('control')
    ...
    <h1 style="text-align: center">Yuridik mijozlarning malumotlari</h1>
    <div class="row m-2">
    ...
    <form action="{{ route('createm5') }}" method="POST" class="shadowe">
        <div class="row m-2">
            @csrf
            <input type="hidden" name="yil_id" id="" value="{{ $yil->id }}">
            <input type="hidden" name="oy_id" id="" value="{{ $oy->id }}">
            ...
            <div class="col-6 mt-3">
                ...
                <input type="text" name="kampaniya" class="form-control" placeholder="Firma nomi" value="{{ old('kampaniya') }}">
            ...
            <div class="col-6 mt-3">
                ...
                <input type="text" name="raxbar" class="form-control" placeholder="Firma raxbari" value="{{ old('raxbar') }}">
            ...
            <div class="col-6 mt-3">
                ...
                <input type="text" name="inn" class="form-control" placeholder="Firma INN" value="{{ old('inn') }}">
        ...
        <h3 style="text-align: center">Mijozni izlash</h3>
            <form action="{{ route('search') }}" method="GET" class="d-flex">
                ...
                <input type="hidden" name="id" id="" value="{{ $kun->id }}">
                <div class="col-5 m-2">
                    <input type="text" class="form-control" placeholder="Mijoz ismi" name="raxbar"  value="{{old('raxbar')}}">
                    <span class="text-danger">@error('raxbar') {{$message}}@enderror</span>
                </div>          
                <div class="col-5 m-2">
        ...
        <div class="row m-3">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>{{ $a->tel }}</td>
                    <td>
                        <a href="{{ route('yuridikedit',$a->id) }}" class="btn btn-success">
                    ...
                    <td>
                        <form method="POST" action="{{ route('yuridikdelet',$a->id)}}">
                            @csrf
                    ...
                    <td>
                        <form method="GET" action="{{ route('malumotlar') }}">
                            @csrf
            ...
            <tbody>
                ...
                <td>{{ $item->kampaniya }}</td>
                <td>{{ $item->raxbar }}</td>
                <td>{{ $item->inn }}</td>
                <td>{{ $item->tel }}</td>
                <td>
                    <a href="{{ route('yuridikedit',$item->id) }}" class="btn btn-success">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                            <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                        </svg>
                    </a>
                ...
                <td>
                    <form method="POST" action="{{ route('yuridikdelet',$item->id)}}">
                        @csrf
                        <input type="hidden" name="yil_id" id="" value="{{ $yil->id }}">
                        <input type="hidden" name="oy_id" id="" value="{{ $oy->id }}">
                        <input type="hidden" name="kun_id" id="" value="{{ $kun->id }}">
