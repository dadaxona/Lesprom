...
@section('control')    
    <h1 style="text-align: center">{{ $jismoniyclenci->mijoz }}</h1>
    <div class="row m-2">
    ...
    <form action="{{ route('create6') }}" method="POST" class="shadowe">
        <div class="row m-2">
            @csrf
            <input type="hidden" name="yil_id" id="" value="{{ $yil->id }}">
            <input type="hidden" name="oy_id" id="" value="{{ $oy->id }}">
            <input type="hidden" name="kun_id" id="" value="{{ $kun->id }}">
            <input type="hidden" name="jismoniyclenci_id" id="" value="{{ $jismoniyclenci->id }}">
        ...
        <table class="table table-dark table-hover">
            ...
            @foreach ($items as $item)
                <tbody>
                    ...
                    <td>
                        <form method="POST" action="{{ route('delete6',$item->id)}}">
                            @csrf
                            <input type="hidden" name="yil_id" id="" value="{{ $yil->id }}">
                            <input type="hidden" name="oy_id" id="" value="{{ $oy->id }}">
                            <input type="hidden" name="kun_id" id="" value="{{ $kun->id }}">
                    ...
                    <td>
                         <form method="GET" action="{{ route('tolov2')}}">
                            @csrf
                            <input type="hidden" name="yil_id" id="" value="{{ $yil->id }}">
                            <input type="hidden" name="oy_id" id="" value="{{ $oy->id }}">
                            <input type="hidden" name="kun_id" id="" value="{{ $kun->id }}">
                            <input type="hidden" name="id" id="" value="{{ $jismoniyclenci->id }}">
