...
class CreateYilumumiychiqimtavarsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yilumumiychiqimtavars', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('yilumumiychiqimtavars');
    }
}
