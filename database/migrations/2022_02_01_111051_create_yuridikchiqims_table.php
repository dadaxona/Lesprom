...
class CreateYuridikchiqimsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yuridikchiqims', function (Blueprint $table) {
            ...
            ->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('clensci_id')->references('id')->on('clenscis')
            ->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('yuridikchiqims');
    }
}
